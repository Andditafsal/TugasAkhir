...
<head>
    ...
    {{-- <link href="{{ asset('images/Logodashboard.png') }}">
    ...
    <link href="{{ asset('css/lib/toastr.min.css') }}" rel="stylesheet">
...
<body>
    ...
    <script src="{{ asset('js/lib/datamap/topojson.j') }}"></script>
    <script src="{{ asset('js/lib/datamap/datamaps.world.min.j') }}"></script>
    <script src="{{ asset('js/lib/datamap/datamap-init.j') }}"></script>

    <!--  Nestable -->
    <script src="{{ asset('js/lib/nestable/jquery.nestable.js') }}"></script>
    <script src="{{ asset('js/lib/nestable/nestable.init.js') }}"></script>

    <!--ION Range Slider JS-->
    <script src="{{ asset('js/lib/rangeSlider/ion.rangeSlider.min.js') }}"></script>
    <script src="{{ asset('js/lib/rangeSlider/moment.js') }}"></script>
    <script src="{{ asset('js/lib/rangeSlider/moment-with-locales.js') }}"></script>
    <script src="{{ asset('js/lib/rangeSlider/rangeslider.init.js') }}"></script>

    <!-- Bar Rating-->
    <script src="{{ asset('js/lib/barRating/jquery.barrating.js') }}"></script>
    <script src="{{ asset('js/lib/barRating/barRating.init.js') }}"></script>

    <!-- jRate -->
    <script src="{{ asset('js/lib/rating1/jRate.min.js') }}"></script>
    <script src="{{ asset('js/lib/rating1/jRate.init.js') }}"></script>
    ...
    <script src="{{ asset('vendor/global/global.min.js') }}" </script>
        < script src = "{{ asset('vendor/bootstrap-select/dist/js/bootstrap-select.min.js') }}" >
            <
            /> <
            script src = "{{ asset('vendor/chart.js/Chart.bundle.min.js') }}" >
    </script>
