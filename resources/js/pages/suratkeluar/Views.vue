    ...
    methods: {
        ...
        getSuratKeluar() {
            ...
            if (this.getUsers === 2) {
                ...
                url = [
                    `suratkeluar/update_pemimpin/${this.$route.params.id}`,
                    {},
                ];
            }
            this.$store
                                ...
                                <form>
                                    ...
                                    <div class="form-row">
                                        ...
                                        >
                                            <label>Kelas *</label>
                                            <input
                                                v-model="suratkeluar.kelasSiswa"
                                                disabled
                                                type="text"
                                                class="form-control"
                                            />
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input
                                                    ...
                                                    class="form-control"
                                                    v-model="
                                                        suratkeluar.waktuMulaiKegiatan
                                                    "
                                                    disabled
                                                />
                                            </div>
