                ...
                <div class="header-content">
                    <nav class="navbar navbar-expand">
                        ...
                        >
                            ...
                            <ul
                                class="navbar-nav header-right main-notification"
                            >
                                <li
                    ...
                    <div class="sub-header">
                        <div
                            class="d-flex align-items-center flex-wrap mr-auto"
                        >
                        ...
                        <div class="d-flex align-items-center">
                            <a
                                href="javascript:void(0);"
                                class="btn btn-xs btn-primary light mr-1"
                                >Today</a
                            >
                            <a
                                href="javascript:void(0);"
    ...
    ***********************************-->
            <div class="deznav">
                <div class="deznav-scroll">
                    <div class="main-profile">
                        ...
                        <p class="email">
                            <a
                                ...
                                class="__cf_email__"
                                data-cfemail="95f8f4e7e4e0f0efefefefd5f8f4fcf9bbf6faf8"
                                >[email&#160;protected]</a
                            >
                        </p>
                    </div>
                    <ul class="metismenu" id="menu">
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false">
                                ...
                                <li>
                                    <a href="page-chat.html"
                                        >Chat<span
                                            class="badge badge-xs badge-danger"
                                            >New</span
                                        ></a
                                    >
                                </li>
                    ...
                    <div class="copyright">
                        <p>
                            <strong>Zenix Crypto Admin Dashboard</strong> © 2021
                            All Rights Reserved
                        </p>
                        <p class="fs-12">
    ...
    ***********************************-->
            ...
            <div class="container max d-flex align-items-center mt-0">
                ...
                <div class="container-fluid">
                    <div
                        class="form-head mb-sm-5 mb-3 d-flex flex-wrap align-items-center"
                    >
                        <h2 class="font-w600 title mb-2 mr-auto">Dashboard</h2>
                        <div class="weather-btn mb-2">
                            <span class="mr-3 font-w600 text-black"
                                ><i class="fa fa-cloud mr-2"></i>21</span
                            >
                            <select
                                class="form-control style-1 default-select mr-3"
                            >
                                <option>Medan, IDN</option>
                                <option>Jakarta, IDN</option>
                                <option>Surabaya, IDN</option>
                        ...
                        <a
                            ...
                            ><i class="las la-calendar scale5 mr-3"></i>Filter
                            Periode</a
                        >
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-xxl-8">
                            <div class="card">
                                <div
                                    class="card-header border-0 flex-wrap pb-0"
                                >
                                    <div class="mb-3">
                                    ...
                                    <div class="d-flex flex-wrap mb-2">
                                        <div
                                            class="custom-control check-switch custom-checkbox mr-4 mb-2"
                                        >
                                            <input
                                                type="checkbox"
                                    ...
                                    <select
                                        class="style-1 btn-secondary default-select"
                                    >
                                ...
                                <div class="col-sm-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body p-3 pb-0">
                                            <div
                                                class="dropdown custom-dropdown d-block tbl-orders"
                                            >
                                                <div
                                                ...
                                                >
                                                    ...
                                                    <div class="text-left ml-3">
                                                        <span
                                                            class="d-block fs-16 text-black"
                                                            >Litecoin</span
                                                        >
                                                    </div>
                                                    <i
                                                        class="fa fa-angle-down scale5 ml-auto"
                                                    ></i>
                                                </div>
                                                <div
                                                    class="dropdown-menu dropdown-menu-right"
                                        ...
                                        <div
                                            class="card-footer border-0 p-0 caret"
                                        >
                                            <a
                                                href="coin-details.html"
                                                class="btn-link"
                                                ><i
                                ...
                                <div class="col-sm-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body p-3 pb-0">
                                            ...
                                            >
                                                <div
                                                    class="btn d-flex align-items-center order-bg border-0 rounded"
                                                    data-toggle="dropdown"
                                                >
                                                    <svg
                                                        width="46"
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    class="table text-center bg-warning-hover tr-rounded order-tbl"
                                                >
                                                    <thead>
                                                        <tr>
                                                            <th
                                ...
                                <div class="col-xl-12 mt-2">
                                    <div class="card">
                                        ...
                                        >
                                            ...
                                            <div
                                                class="dropdown custom-dropdown d-block mt-3 mt-sm-0 mb-0"
                                            >
                                                <div
                                                    class="btn btn-light d-flex align-items-center svg-btn"
                                                    role="button"
                                                    data-toggle="dropdown"
                                                    aria-expanded="false"
                                                >
                                                    ...
                                                    >
                                                    <i
                                                        class="fa fa-angle-down text-black scale3 ml-2"
                                                    ></i>
                                                </div>
                                                <div
                                                    class="dropdown-menu dropdown-menu-right"
                                ...
                                <div class="col-sm-6">
                                    <div class="card-bx stacked card">
                                        ...
                                        <div class="card-info">
                                            ...
                                            >
                                                <h2
                                                    class="num-text text-white mb-5 font-w600"
                                                >
                                                    $673,412.66
                                                </h2>
                                                <svg
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        ...
                                        >
                                            ...
                                            <div
                                                class="card-action card-tabs mb-3 style-1"
                                            >
                                                <ul
                                                    class="nav nav-tabs"
                                                    role="tablist"
                                        ...
                                        <div
                                            class="card-footer border-0 p-0 caret mt-1"
                                        >
                                            <a
                                                href="coin-details.html"
                                                class="btn-link"
                                ...
                                <div class="col-xl-12 mt-2">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div
                                                class="d-flex mb-3 mt-3 justify-content-between align-items-center"
                                            >
                                                <h4
                                                    class="text-black fs-20 mb-0"
                                                >
                                                    Recent Contacts
                                                </h4>
                                                <a
                                            ...
                                            >
                                                <div class="items">
                                                    <div class="text-center">
                                                        <img
                                                            class="mb-3 rounded"
                                                            src="images/contacts/Untitled-1.jpg"
                                                            alt=""
                                                        />
                                                        <h5 class="mb-0">
                                                            <a
                                                ...
                                                <div class="items">
                                                    <div class="text-center">
                                                        <img
                                                            class="mb-3 rounded"
                                                            src="images/contacts/Untitled-2.jpg"
                                                            alt=""
                                                        />
                                                        <h5 class="mb-0">
                                                            <a
                                                ...
                                                <div class="items">
                                                    <div class="text-center">
                                                        <img
                                                            class="mb-3 rounded"
                                                            src="images/contacts/Untitled-3.jpg"
                                                            alt=""
                                                        />
                                                        <h5 class="mb-0">
                                                            <a
                                                ...
                                                <div class="items">
                                                    <div class="text-center">
                                                        <img
                                                            class="mb-3 rounded"
                                                            src="images/contacts/Untitled-4.jpg"
                                                            alt=""
                                                        />
                                                        <h5 class="mb-0">
                                                            <a
                                                ...
                                                <div class="items">
                                                    <div class="text-center">
                                                        <img
                                                            class="mb-3 rounded"
                                                            src="images/contacts/Untitled-5.jpg"
                                                            alt=""
                                                        />
                                                        <h5 class="mb-0">
                                                            <a
                                            ...
                                            <div
                                                class="row pt-sm-5 pt-3 align-items-center"
                                            >
                                                <div
                                                    class="col-sm-6 mb-sm-0 mb-3"
                                                >
                                                    <p class="mb-0 fs-14">
                                                ...
                                                <div class="col-sm-6">
                                                    <a
                                                        href="javascript:void(0);"
                                                        class="btn btn-secondary d-block btn-lg"
                                                        >TRANSFER NOW</a
                                                    >
                                                </div>
                                            </div>
            ...
            <div class="footer">
                <div class="copyright">
                    <p>
                        ...
                        <a href="../index.htm" target="_blank">DexignZone</a>
                        2021
                    </p>
                </div>
            </div>
