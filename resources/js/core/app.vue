            ...
            <div class="nano">
                <div class="nano-content">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="index.html" class="sidebar">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="uc-range-slider-basic.html"
                                        >Basic Range Slider</a
                                    >
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="uc-rating-bar-rating.html"
                                        >Bar Rating</a
                                    >
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="table-row-select.html"
                                        >Datatable Row Select</a
                                    >
                                </li>
                                <li>
                        ...
                        <div class="float-right">
                            <div class="dropdown dib">
                                <div class="header-icon" data-toggle="dropdown">
                                    <i class="ti-bell"></i>
                                    <div
                                        class="drop-down dropdown-menu dropdown-menu-right"
                                    >
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="#">
                                                        ...
                                                        >
                                                            <small
                                                                class="notification-timestamp pull-right"
                                                                >02:34 PM</small
                                                            >
                                                            <div
                                ...
                                <div class="header-icon" data-toggle="dropdown">
                                    ...
                                    >
                                        <div class="dropdown-content-heading">
                                            ...
                                            <a href="email.html">
                                                <i
                                                    class="ti-pencil-alt pull-right"
                                                ></i>
                                            </a>
                                        </div>
                                        <div class="dropdown-content-body">
